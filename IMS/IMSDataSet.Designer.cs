...
namespace IMS {
    ...
    public partial class IMSDataSet : global::System.Data.DataSet {
        ...
        public partial class USERINFODataTable : global::System.Data.TypedTableBase<USERINFORow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public USERINFORow AddUSERINFORow(string FirstName, string LastName, string UserName, string MobileNo, string Email, string Password) {
        ...
        public partial class USERINFORow : global::System.Data.DataRow {
            ...
            public string MobileNo {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'MobileNo\' in table \'USERINFO\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsMobileNoNull() {
                return this.IsNull(this.tableUSERINFO.MobileNoColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetMobileNoNull() {
                this[this.tableUSERINFO.MobileNoColumn] = global::System.Convert.DBNull;
            }
...
namespace IMS.IMSDataSetTableAdapters {
    ...
    public partial class USERINFOTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[USERINFO] ([FirstName], [LastName], [UserName], [MobileNo], [Email], [Password]) VALUES (@FirstName, @LastName, @UserName, @MobileNo, @Email, @Password);
SELECT UserID, FirstName, LastName, UserName, MobileNo, Email, Password FROM USERINFO WHERE (UserID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[USERINFO] SET [FirstName] = @FirstName, [LastName] = @LastName, [UserName] = @UserName, [MobileNo] = @MobileNo, [Email] = @Email, [Password] = @Password WHERE (([UserID] = @Original_UserID) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ([UserName] = @Original_UserName) AND ((@IsNull_MobileNo = 1 AND [MobileNo] IS NULL) OR ([MobileNo] = @Original_MobileNo)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ([Password] = @Original_Password));
SELECT UserID, FirstName, LastName, UserName, MobileNo, Email, Password FROM USERINFO WHERE (UserID = @UserID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::IMS.Properties.Settings.Default.IMSConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, FirstName, LastName, UserName, MobileNo, Email, Password FROM dbo." +
                "USERINFO";
        ...
        public virtual int Fill(IMSDataSet.USERINFODataTable dataTable) {
        ...
        public virtual IMSDataSet.USERINFODataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            IMSDataSet.USERINFODataTable dataTable = new IMSDataSet.USERINFODataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(IMSDataSet.USERINFODataTable dataTable) {
        ...
        public virtual int Delete(int Original_UserID, string Original_FirstName, string Original_LastName, string Original_UserName, string Original_MobileNo, string Original_Email, string Original_Password) {
        ...
        public virtual int Insert(string FirstName, string LastName, string UserName, string MobileNo, string Email, string Password) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string UserName, string MobileNo, string Email, string Password, int Original_UserID, string Original_FirstName, string Original_LastName, string Original_UserName, string Original_MobileNo, string Original_Email, string Original_Password, int UserID) {
            if ((FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string UserName, string MobileNo, string Email, string Password, int Original_UserID, string Original_FirstName, string Original_LastName, string Original_UserName, string Original_MobileNo, string Original_Email, string Original_Password) {
            return this.Update(FirstName, LastName, UserName, MobileNo, Email, Password, Original_UserID, Original_FirstName, Original_LastName, Original_UserName, Original_MobileNo, Original_Email, Original_Password, Original_UserID);
        }
    }
